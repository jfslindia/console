...
class ConsoleSettings{
    ...
    function __construct()
    {
        ...
        $mobile_image_sub_menu[0]['SUB_MENU'] = 'ESSENTIALPOPUPS';
        $mobile_image_sub_menu[0]['SUB_MENU_ICON'] = 'list';
        $mobile_image_sub_menu[0]['SUB_MENU_LINK'] = base_url() . 'console/essentialpopups';

        $mobile_image_sub_menu[1]['SUB_MENU'] = 'TIPS';
        $mobile_image_sub_menu[1]['SUB_MENU_ICON'] = 'list';
        $mobile_image_sub_menu[1]['SUB_MENU_LINK'] = base_url() . 'console/tips';

        $mobile_image_sub_menu[2]['SUB_MENU'] = 'WASHIMAGES';
        $mobile_image_sub_menu[2]['SUB_MENU_ICON'] = 'list';
        $mobile_image_sub_menu[2]['SUB_MENU_LINK'] = base_url() . 'console/wash_images';

        $mobile_image_sub_menu[3]['SUB_MENU'] = 'POPUP';
        $mobile_image_sub_menu[3]['SUB_MENU_ICON'] = 'list';
        $mobile_image_sub_menu[3]['SUB_MENU_LINK'] = base_url() . 'console/popups';

        $mobile_image_sub_menu[4]['SUB_MENU'] = 'FABHOME';
        $mobile_image_sub_menu[4]['SUB_MENU_ICON'] = 'list';
        $mobile_image_sub_menu[4]['SUB_MENU_LINK'] = base_url() . 'console/fabhome';
        
        $pages['FABRICSPA BANNERS'] = array(
            'NAME' => 'FABRICSPA BANNERS', 'LINK' => base_url() . 'console/essentialpopups',
            'ICON' => 'list',
            'SUB_MENU' => TRUE,
            'SUB_MENU_ARRAY' => $mobile_image_sub_menu

        );
        $pages['FABRICSPA DELETED USERS'] = array('NAME' => 'FABRICSPA DELETED USERS', 'SUB_MENU' => FALSE, 'LINK' => base_url() . 'consoleadmin/fabricspa_deleted_users', 'ICON' => 'users');
        $pages['COUPONS'] = array('NAME' => 'COUPONS', 'SUB_MENU' => FALSE, 'LINK' => base_url() . 'consoleadmin/coupons', 'ICON' => 'tag');
        $pages['CAMPAIGNS'] = array('NAME' => 'CAMPAIGNS', 'SUB_MENU' => FALSE, 'LINK' => base_url() . 'console/campaigns', 'ICON' => 'happy');
        ...
        // $pages['FABHOME'] = array('NAME' => 'FABHOME RATE MASTER', 'SUB_MENU' => FALSE, 'LINK' => base_url() . 'consoleadmin/fab_home', 'ICON' => 'credit-card');
         $fabhome_sub_menu[0]['SUB_MENU'] = 'ADD SERVICES';
        $fabhome_sub_menu[0]['SUB_MENU_ICON'] = 'list';
        $fabhome_sub_menu[0]['SUB_MENU_LINK'] = base_url() . 'consoleadmin/fabhome_services';

        $fabhome_sub_menu[1]['SUB_MENU'] = 'ADD RATES';
        $fabhome_sub_menu[1]['SUB_MENU_ICON'] = 'list';
        $fabhome_sub_menu[1]['SUB_MENU_LINK'] = base_url() . 'consoleadmin/fab_home';

        $pages['FABHOME'] = array(
            'NAME' => 'FABHOME RATE MASTER', 'LINK' => base_url() . 'consoleadmin/fab_home',
            'ICON' => 'list',
            'SUB_MENU' => TRUE,
            'SUB_MENU_ARRAY' => $fabhome_sub_menu

        );
        $pages['FABHOME ORDERS'] = array('NAME' => 'FABHOME ORDERS', 'SUB_MENU' => FALSE, 'LINK' => base_url() . 'consoleadmin/fabhome_orders', 'ICON' => 'credit-card');
        ...
        $dcr_sub_menu[0]['SUB_MENU'] = 'USERS';
        $dcr_sub_menu[0]['SUB_MENU_ICON'] = 'user';
        $dcr_sub_menu[0]['SUB_MENU_LINK'] = base_url() . 'consoleadmin/dcr';

        $dcr_sub_menu[1]['SUB_MENU'] = 'COLLECTION SUMMARY';
        $dcr_sub_menu[1]['SUB_MENU_ICON'] = 'list';
        $dcr_sub_menu[1]['SUB_MENU_LINK'] = base_url() . 'consoleadmin/dcr_reports';
        $pages['DCR'] = array('NAME' => 'DCR', 'SUB_MENU' => TRUE, 'LINK' => base_url() . 'consoleadmin/dcr', 'ICON' => 'mail','SUB_MENU_ARRAY' => $dcr_sub_menu);
