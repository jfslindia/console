...
class ConsoleSettings{
    ...
    function __construct()
    {
        ...
        $mobile_image_sub_menu[2]['SUB_MENU'] = 'SCHEDULEWASHIMAGES';
        ...
        $pages['MOBILEIMAGES'] = array(
            'NAME' => 'MOBILEIMAGES', 'LINK' => base_url() . 'console/essentialpopups',
            'ICON' => 'list',
            'SUB_MENU' => TRUE,
            'SUB_MENU_ARRAY' => $mobile_image_sub_menu

        );
        $pages['COUPONS'] = array('NAME' => 'COUPONS', 'SUB_MENU' => FALSE, 'LINK' => base_url() . 'console/coupons', 'ICON' => 'tag');
