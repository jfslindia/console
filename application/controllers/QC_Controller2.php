...
/**
 * Class QC_Controller
 * @property QC_Model2 $QC_Model2
 * @property generic $generic
 */
class QC_Controller2 extends CI_Controller
{
    ...
    public function get_garment_details()
    {
        ...
        $tag_no = $body['TagNo'];
        $garment_details = $this->QC_Model2->get_log_data($tag_no);
    ...
    public function file_upload()
    {
        ...
        if (is_uploaded_file($_FILES['uploaded_file']['tmp_name'])) {
            ...
            if ($upload) {
                ...
                $save_images = $this->QC_Model2->save_qc_images($image_array);
    ...
    public function get_reasons()
    {
        ...
        $reasons = $this->QC_Model2->get_reasons_from_fabricare();
    ...
    public function save_log()
    {
        ...
        $this->QC_Model2->update_customer_unique_url($body['CustomerCode'], $customer_sui_short_link);

        //Update the QC status in the Fabricare.
        $fabricare_update_status = $this->QC_Model2->update_qc_status_in_fabricare($body['TagNo'], $body['Reason'], $body['QCUserID'], $image_0, $image_1, $image_2, $customer_sui_short_link,$status);
    ...
    private function generate_cipher_for_customer($customer_code)
    {
        ...
        $fabricare_customer_details = $this->QC_Model2->get_fabricare_customer_details($customer_code);
        ...
        $qc_customer_details = $this->QC_Model2->get_qc_customer_details($customer_code);
        ...
        if (!$qc_customer_details) {
            ...
            $customer_details = $this->QC_Model2->save_customer_details($customer_details);
    ...
    private function send_gcmid($log)
    {
        ...
        $fabricspa_gcmid = $this->QC_Model2->get_fabricspa_gcmid($customer_id);
