...
class QC_SUI_Interface extends CI_Controller {
	...
	public function save_response($cipher=FALSE){
		...
		if($log_data[0]['QCStatus']=='QCPending'){
			$fabricare_update_status=$this->QC_SUI_Model->update_qc_status_in_fabricare($tag_no,$customer_id,$customer_response,$log_data[0]['Remarks'],'',$log_data[0]['ImageLink1'],$log_data[0]['ImageLink2'],$log_data[0]['ImageLink3'],$detailed_response);
		}else{
