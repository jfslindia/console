...
class DCR_Controller extends CI_Controller
{
    ...
    public function deposit_collections()
    {
        ...
        if ($deposit) {
            ...
            $this->send_deposits_mail($date, $topic, $subject, $image_attachment, $report_attachment, $total_amount, $user_name, $city_name);
...
/*Email API configurations*/
        ...
        $this->email->from('no-reply@' . strtolower('JFSL') . '.com', $topic);
        ...
        if (IS_TESTING) {
            $this->email->to('jfsl.mdm@jyothy.com');
        } else {
            $this->email->to('jfsl.mdm@jyothy.com,' . $email_id_of_branch['EmailID']);
            $cc = 'vidhya.r@jyothy.com,magesh.r@jyothy.com,collection@jfsl.in,jfsl.mdm@jyothy.com,Shilpa.n@jyothy.com,santosh.n@jyothy.com,sridhara.murthybm@jyothy.com,myappa.r@jyothy.com,Kiran.ms@jyothy.com,sukanta.kishor@jyothy.com';
            ...
            if ($branch_name == 'WARDROBE CDC - SECTOR 15A NOIDA' || $branch_name == 'WARDROBE CDC - SECTOR 52 NOIDA' || $branch_name == 'WARDROBE CDC - NOIDA  SECTOR -41' || $branch_name == 'WARDROBE CDC - VAILSHALI' || $branch_name == 'WARDROBE CDC - INDIRAPURAM') {
     ...
     * @return bool
     */
    private function send_deposits_mail($date, $topic, $subject, $image_attachment, $report_attachment, $total_amount, $user_name, $city_name)
    {
        /*Loading email library*/
        $this->load->library('email', array('mailtype' => 'html'));
...
/*Email API configurations*/
        ...
        if (IS_TESTING) {
            ...
            $this->email->to('jfsl.mdm@jyothy.com');
            $cc = 'vidhya.r@jyothy.com,magesh.r@jyothy.com,collection@jfsl.in,jfsl.mdm@jyothy.com,Shilpa.n@jyothy.com,santosh.n@jyothy.com,sridhara.murthybm@jyothy.com,myappa.r@jyothy.com,Kiran.ms@jyothy.com,sukanta.kishor@jyothy.com,Rajesh.m@jyothy.com,Babu.murali@jyothy.com,Konda.rameshbabu@jyothy.com';
