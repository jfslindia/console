...
/**
 * Class QC_Controller
 * @property QC_ModelTwo $QC_ModelTwo
 * @property generic $generic
 */
class QC_ControllerTwo extends CI_Controller
{
    ...
    public function login()
    {
        ...
        $curl = curl_init();
        if (IS_TESTING)
            $api_url = "http://115.113.224.138:8096/api/JFSL/CheckIsValidLogIn";
        else
            $api_url = "http://115.113.224.139:8095/api/JFSL/CheckIsValidLogIn";
    ...
    public function get_garment_details()
    {
        ...
        $tag_no = $body['TagNo'];
        $garment_details = $this->QC_ModelTwo->get_log_data($tag_no);
    ...
    public function file_upload()
    {
        ...
        if (is_uploaded_file($_FILES['uploaded_file']['tmp_name'])) {
            ...
            if ($upload) {
                ...
                $save_images = $this->QC_ModelTwo->save_qc_images($image_array);
    ...
    public function get_reasons()
    {
        ...
        $reasons = $this->QC_ModelTwo->get_reasons_from_fabricare();
    ...
    public function save_log()
    {
        ...
        $this->QC_ModelTwo->update_customer_unique_url($body['CustomerCode'], $customer_sui_short_link);

        //Update the QC status in the Fabricare.
        $fabricare_update_status = $this->QC_ModelTwo->update_qc_status_in_fabricare($body['TagNo'], $body['Reason'], $body['QCUserID'], $image_0, $image_1, $image_2, $customer_sui_short_link,$status);
    ...
    private function generate_cipher_for_customer($customer_code)
    {
        ...
        $fabricare_customer_details = $this->QC_ModelTwo->get_fabricare_customer_details($customer_code);
        ...
        $qc_customer_details = $this->QC_ModelTwo->get_qc_customer_details($customer_code);
        ...
        if (!$qc_customer_details) {
            ...
            $customer_details = $this->QC_ModelTwo->save_customer_details($customer_details);
    ...
    private function send_gcmid($log)
    {
        ...
        $fabricspa_gcmid = $this->QC_ModelTwo->get_fabricspa_gcmid($customer_id);
