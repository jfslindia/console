...
$route['consoleadmin/get_userwise_coupons'] = $route['consoleadmin'].'/get_userwise_FR_coupons';

$route['consoleadmin/dcr'] = $route['consoleadmin'].'/admin_dcr';
$route['consoleadmin/dcr_reports'] = $route['consoleadmin'].'/admin_dcr_reports';
