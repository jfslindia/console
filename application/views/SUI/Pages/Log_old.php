...
<a class="uk-visible@m" uk-tooltip="Go back" style="position: fixed;bottom: 0;"
...
<div ng-app="sui" ng-controller="sui_form" block-ui="main">
    <div class="uk-margin-large-top uk-margin-large-bottom">
        <div class="uk-container uk-container-medium uk-margin-top">
            ...
            <h4 class="uk-text-center uk-margin-remove">Tag No <?php echo $tag_no; ?></h4>
                ...
                <table class="uk-table uk-table-striped">
                    ...
                    <tr>
                        ...
                        <?php if (strtoupper($log_data['QCStatus']) == 'APPROVED') { ?>
                            <td class="uk-text-success"><?php echo $log_data['QCStatus']; ?></td>
                        <?php } else { ?>
                            <td><?php echo $log_data['QCStatus']; ?></td>
                        <?php } ?>
                    </tr>
            ...
            <?php if (strtoupper($log_data['QCStatus']) == 'QCPENDING') { ?>
                <div class="uk-width-1-2@m uk-margin-auto box">
                    <h4 class="uk-text-primary uk-margin-remove">Dear <?php echo $garment_details['Name']; ?>, please
                        take
                        necessary action.</h4>
                    ...
                    <form>
                        ...
                        <input type="hidden" name="tag_no" ng-model="tag_no" ng-init="tag_no='<?php echo $tag_no; ?>'" ng-value="<?php echo $tag_no; ?>">
                        <input type="hidden" name="customer_id" ng-model="customer_id" ng-init="customer_id='<?php echo $log_data['CustomerCode']; ?>'" ng-value="<?php echo $log_data['CustomerCode']; ?>">

                      <!--  <div class="uk-margin uk-grid-small uk-child-width-auto uk-flex uk-flex-center uk-grid" ng-init="response=true">
                            <label><input name="response" class="uk-radio" type="radio" ng-value="true" ng-model="response"> Approve
                                and
                                go ahead</label>
                            <label><input name="response" class="uk-radio" type="radio" ng-value="false" ng-model="response"> Reject and
                                return my
                                garment.</label>
                        </div>-->

                        <div class="uk-padding-small">
                            <button class="uk-button uk-button-danger btnsubmit" ng-click="rejected(); $event.stopPropagation();">REJECT</button>
                            <button class="uk-button uk-button-success btnsubmit" ng-click="approved(); $event.stopPropagation();">APPROVE</button>
            ...
            <?php } else { ?>
                ...
                <div class="uk-width-1-2@m uk-margin-auto uk-margin-top">
                    ...
                    <p>
                        You <span
                            style="font-style: italic;"><?php echo $log_data['QCStatus']; ?></span> the garments for
                        further
                        process.
    ...
    <a id="m_navigation" class="uk-hidden@m" uk-tooltip="Go back"
       href="<?php echo base_url(); ?>sui/<?php echo $cipher['UniqueCode']; ?>/logs">
        <span class="uk-margin-small-right" uk-icon="icon: arrow-left; ratio: 2"></span>
    </a>
    ...
    <div id="confirmation_model" class="uk-flex-top" uk-modal>
        <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-padding-remove-bottom">
            ...
            <p class="uk-text-justify uk-text-center uk-text-primary uk-margin-remove" style="line-height: 1.3">Your garment will be
                delivered <span style="font-weight: 600;text-decoration: underline">a day later</span> than the
                committed delivery date, as it had to undergo a special approval process from our pre-process QC team
            </p>


            <div class="uk-padding-small uk-text-center">
                <button class="uk-button uk-button-default uk-modal-close" type="button">Cancel</button>
                <button class="uk-button uk-button-primary subm" type="button" ng-click="save_response()">Save</button>
            </div>
        </div>
    </div>
</div>
