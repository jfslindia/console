...
{
background-color:#51e12d !important;
color:#fff !important;
text-align:center;
}
.go_back
...
<a class="uk-visible@m newFont" uk-tooltip="Go back" style="position: fixed;bottom: 0;"
...
model="response"> Reject and
                        ...
                        <div class="uk-padding-small">
                            <button class="uk-button uk-button-danger btnsubmit viewmoreBgColorDanger" ng-click="rejected(); 
