...
<head>
    ...
    <?php if(isset($cipher)) { ?>
    <script>var home_url="<?php echo base_url() . 'sui/'.$cipher;?>";</script>
    <?php } else { ?>
    <script>var home_url="";</script>
    <?php } ?>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/custom/sui.min.js"></script>
        ...
        <nav class="uk-navbar-container" uk-navbar="mode: click"
            ...
            <div class="uk-navbar-right">
                ...
                <ul class="uk-navbar-nav">
                    ...
                    <li><a style="font-size:14px !important;" class="header_menu flex_end uk-padding-remove-right"
                           href="https://fabricspa.com/">HOME</a></li>
                    ...
                    if ($this->uri->segment(1) == 'essentials') {
                        ...
                        <li><a style="font-size:14px !important;" class="header_menu flex_end active_page"
                               href="https://fabricspa.com/essentials">ESSENTIALS</a>
                        </li>

                    <?php } else { ?>
                        <li><a style="font-size:14px !important;" class="header_menu flex_end"
                               href="https://fabricspa.com/essentials">ESSENTIALS</a></li>
                    <?php } ?>
                    ...
                    if ($this->uri->segment(1) == 'partner_with_us') {
                        ...
                        <li><a style="font-size:14px !important;" class="header_menu flex_end active_page"
                               href="https://fabricspa.com/partner_with_us">PARTNER
                                WITH US</a></li>

                    <?php } else { ?>
                        <li><a style="font-size:14px !important;" class="header_menu flex_end"
                               href="https://fabricspa.com/partner_with_us">PARTNER WITH
                                US</a></li>
                    ...
                    if ($this->uri->segment(1) == 'blog') {
                        ...
                        <li><a style="font-size:14px !important;" class="header_menu flex_end active_page"
                               href="https://fabricspa.com/blog">BLOG</a></li>
                    ...
                    if ($this->uri->segment(1) == 'fabricspa_story') {
                        ...
                        <li><a style="font-size:14px !important;" class="header_menu active_page flex_end"
                               href="https://fabricspa.com/fabricspa_story">ABOUT
                                US</a></li>
                    ...
                    <?php } else { ?>
                        ...
                        <li><a style="font-size:14px !important;" class="header_menu flex_end"
                               href="https://fabricspa.com/fabricspa_story">ABOUT US</a>
                        </li>
                    <?php } ?>
                        ...
                        <div class="uk-navbar-dropdown">
                            <ul class="uk-nav uk-navbar-dropdown-nav">
                                ...
                                if ($this->uri->segment(1) == 'essentials') {
                                    ...
                                    <li><a style="font-size:14px !important;" class="header_menu active_page"
                                           href="https://fabricspa.com/essentials">ESSENTIALS</a>
                                    </li>

                                <?php } else { ?>

                                    <li><a style="font-size:14px !important;" class="header_menu "
                                           href="https://fabricspa.com/essentials">ESSENTIALS</a>
                                    </li>
                                ...
                                if ($this->uri->segment(1) == 'our_stores') {
                                    ...
                                    <li><a style="font-size:14px !important;" class="header_menu active_page"
                                           href="https://fabricspa.com/our_stores">STORES</a>
                                    </li>
                                ...
                                if ($this->uri->segment(1) == 'contact_us') {
                                    ...
                                    <li><a style="font-size:14px !important;" class="header_menu active_page"
                                           href="https://fabricspa.com/contact_us">CONTACT</a>
                                    </li>
                                ...
                                if ($this->uri->segment(1) == 'blog') {
                                    ...
                                    <li><a style="font-size:14px !important;" class="header_menu active_page"
                                           href="https://fabricspa.com/blog">BLOG</a>
                                    </li>
