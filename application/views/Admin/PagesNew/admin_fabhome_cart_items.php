		...
		<header class="page-header">
			...
			<div class="right-wrapper text-right">
				<ol class="breadcrumbs">
					...
					<li><span><a href="<?php echo site_url('consoleadmin/fabhome_orders'); ?>"><h2>Orders</h2></span></li>
...
echo date_format($date,"Y/m/d ");?></span>
					...
					<table class="table table-responsive-md invoice-items">
						...
						<tr>
							...
							<td class="text-center"><i class="fa fa-rupee-sign" aria-hidden="true"></i> <?php echo $cart_items[$i]['price']; ?></td>
