		...
		<header class="page-header">
			...
			<div class="right-wrapper text-right mr-5">
				<ol class="breadcrumbs">
					...
					<li><a class="btn btn-sm btn-primary" href="<?php echo base_url(); ?>consoleadmin/fabhome_orders">
							<i class="fas fa-shopping-bag"></i> <span> View Cart</span>
						</a></li> -->
						<li><h2>Rate</h2></li>
								...
								<div id="deep" class="tab-pane active">
									<table id="deep_table" style="width: 100%"
										...
										<tr>
											...
											<th width="1%">Discount<?php echo "</br>";?>(%)</th>
			...
			<div class="modal-body">
				<form class="uk-form-horizontal uk-width-expand">
					...
					<div class="uk-margin">
						<label class="uk-form-label" for="form-horizontal-text">Input UOM:</label>
						<div class="uk-form-controls">
							<select class="uk-select" id="edit_input_uom">
								<option value="NOS">NOS</option>
								<option value="SQFT">SQFT</option>
							</select>
						</div>
