                        ...
                        <div class="uk-margin-bottom">
                            <div id="<?php echo $tip[0]['id']; ?>_card" class="uk-card uk-card-default">
                                <div class="uk-card-media-top">
                                    <img popup_id="<?php echo $tip[0]['id']; ?>"
                                         src="<?php echo $tip[0]['url']; ?>" alt="">
                                </div>
                                <div class="uk-card-footer">
                                    <p>
                                        <a onclick="delete_tip(<?php echo $tip[0]['id']; ?>)"><span
...
<script>
    ...
    function add_tip() {            
            var tip_image = $('#new_offer_image').attr('src');
                ...
                jQuery.ajax({
                    ...
                    success: function (res) {
                        if (res == 'success') {
                            ...
                            UIkit.notification({
                                message: 'Please delete the existing data and try again',
                                status: 'danger',
                                pos: 'bottom-center',
                                timeout: 1000
                            });
