...
<script type="text/javascript">
    ...
    $('input[type=radio][name=automate]').change(function(){
        ...
        $('#schedule_notification').click(function () {
            ...
            //     if(schedule_date == today){
            //         var currentTime = new Date().getTime();
            //         var time = Date.parse(today+time_slot);
            //         if(currentTime>time){
            //             UIkit.notification({
            //                 message: 'Invalid date and timeslot',
            //                 status: 'danger',
            //                 pos: 'bottom-center',
            //                 timeout: 1000
            //             });
    ...
    function send_automated_gcmids(start, limit,flag) {
        ...
        var message = $('#message').val();
        var state = $('#state').val();
        var autoamte = $('input[type=radio][name=automate]:checked').val();
        var location = [];
        var user = "<?php echo $username; ?>";
...
<div id="page-1-container"
    ...
    <div class="uk-card uk-align-center uk-card-default uk-card-hover uk-card-body">
        ...
        <button id="show_details" type="button" class = "w3-button w3-sand" onclick="window.location='<?php echo site_url('console/get_notification_details');?>'">Show Details</button><br>
        <!--<h4 class="uk-text-center">Send Push Notification</h4><br>-->
