...
<div class="uk-width-1-1@s uk-width-4-5@m uk-width-5-6@m uk-margin-auto-left content_wrapper uk-padding">
    <div class="page-container">
        ...
        <div class="uk-card uk-align-center uk-card-default uk-card-hover uk-card-body">
            ...
            <h3 class="uk-heading-divider uk-text-center">EssentialPopup Details</h3>
                        ...
                        <div id="" class="uk-card uk-card-default">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title new_editable" id="new_title"
                                    contenteditable="true" value="">New Essentialpopup</h3>
                            </div>
                            <div class="uk-card-body">
                            ...
                            <div id="<?php echo $p['id']; ?>_card" class="uk-card uk-card-default">
                                ...
                                <div class="uk-card-body">
                                    <h3 class="uk-card-title editable" id="<?php echo $p['id']; ?>_title"
                                        contenteditable="true"><?php echo $p['title']; ?></h3>
                                    <h3 class="uk-card-title editable" id="<?php echo $p['id']; ?>_title"
                                        contenteditable="true"><?php echo $p['site_url']; ?></h3>
                                   <!--  <h3 class="uk-card-title editable" id="<?php echo $p['id']; ?>_title"
                                        contenteditable="true"><?php if($p['city'] != "NULL"){?><?php echo $p['city']; ?> <?php }?><?php echo $p['state']; ?></h3> -->
                                     <h3 class="uk-card-title editable" id="<?php echo $p['id']; ?>_title"
                                        contenteditable="true"><?php if($p['city'] != "NULL"){?><?php echo $p['city']; ?>(<?php echo $p['state']; ?>)<?php }else{ echo $p['state']; } ?></h3>
                                    <?php if ($p['brandcode'] == 'PCT0000001') { ?>
                                        <select id="<?php echo $p['id']; ?>_brand"
                                            class="new_editable_brand uk-select">
                                            <option value="PCT0000001" selected>Fabricspa</option>
                                            <option value="PCT0000014">Click2Wash</option>
                                        </select>
                                    <?php } else if ($p['brandcode'] == 'PCT0000014'){ ?>
                                        <select id="<?php echo $p['id']; ?>_brand"
                                            class="new_editable_brand uk-select">
                                ...
                                <div class="uk-card-footer">
                                    <p>
                                        <a onclick="delete_essential(<?php echo $p['id']; ?>)"><span
                                                class="uk-margin-small-right" uk-icon="trash"></span>Delete</a></p>
                                    <!-- <p>
                                        <button onclick="save_changes(<?php echo $popups[$i]['id']; ?>)"
                                                id="<?php echo $popups[$i]['id']; ?>_save"
