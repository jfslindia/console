...
<div class="uk-width-1-1@s uk-width-4-5@m uk-margin-auto-left content_wrapper uk-padding">
    <div class="page-container">
        ...
        <div ng-controller="qa_users">
            <div class="uk-card uk-card-body uk-card-default">
                <table class="uk-table uk-table-hover uk-table-divider">
                    <div class="uk-margin uk-text-right">
                        <button class="uk-button uk-button-default" ng-click="add_qa_user()">Add a user</button>
                        <div class="uk-inline">
                    ...
                    <tr>
                        ...
                        <th>Edit</th>
                        <th>
                            <button uk-icon="icon: trash; ratio:1.2;" ng-click="delete_qa_users()"
                                    title="Delete the qa_user" uk-tooltip></button>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    <!--<tr  ng-repeat="qa_user in qa_users | filter:search">-->
                    <tr ng-repeat="qa_user in results.qa_users |orderBy:orderByField:reverseSort | filter:search">
                        <!--      <tr  ng-repeat="qa_user in qa_users | filter:search">-->
                        <td><input type="checkbox" name="qa_user_row" class="uk-checkbox" value="{{qa_user.Id}}">
                        </td>
                        ...
                        <td>
                            <a href="#qa_user_modal"
                               ng-click="edit_qa_user(qa_user.Id,results.qa_users.indexOf(qa_user))"
            ...
            <div id="qa_user_modal" class="uk-modal-container" uk-modal="bg-close:false">
                <div class="uk-modal-dialog">
                    ...
                    <div class="uk-modal-body" uk-overflow-auto>
                        ...
                        <form class="uk-form-horizontal">
                            <input type="text" id="qa_user_modal_details" hidden>
                    ...
                    <div class="uk-modal-footer uk-text-right">
                        ...
                        <button class="uk-button uk-button-primary" type="button" ng-click="save_qa_user()">Save
                        </button>
                    </div>
