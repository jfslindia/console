        ...
        <div ng-controller="qa_logs">
            ...
            <div id="chart_card" class="uk-card uk-card-default uk-card-small uk-card-hover uk-width-auto">
                <div class="uk-card-header">
                    <div class="uk-grid uk-grid-small">
                        <div class="uk-width-auto"><h4>QA Logs</h4></div>
                        <div class="uk-width-expand uk-text-right panel-icons">

                            <a ng-click="qa_logs_close_chart()" href="#" class="uk-icon-link" title="Close"
            ...
            <div class="uk-card uk-card-body uk-card-default">
                <div class="uk-overflow-auto" style="max-height: 765px;">
                    <table class="uk-table uk-table-hover uk-table-divider" style="width: max-content;  ">
                        <div class="uk-margin uk-text-left">

                            <div class="uk-inline">
                                <a class="uk-form-icon" href="#" uk-icon="icon: search"></a>
                                <input class="uk-input " placeholder="Search Tag ID" type="text" ng-model="search"
                        ...
                        <?php  for ($i = 0; $i < sizeof($logs); $i++) {
                            ...
                            <tr id="table_row">
                                ...
                                <td><?php echo $logs[$i]['FinishedBy']; ?></td>

                                <td><?php echo $logs[$i]['SubmittedBy']; ?></td>

                                <td><?php echo $logs[$i]['OtherReason']; ?></td>
