...
<div class="uk-width-1-1@s uk-width-4-5@m uk-width-5-6@m uk-margin-auto-left content_wrapper uk-padding">
    <div class="page-container">
        ...
        <div ng-controller="dcr">
            <div class="uk-card uk-card-body uk-card-default">
                <table class="uk-table uk-table-hover uk-table-divider">
                    <div class="uk-margin uk-text-right">
                        <button class="uk-button uk-button-default" ng-click="add_dcr_user()">Add a user</button>
                        <div class="uk-inline">
                    ...
                    <tr>
                        ...
                        <th>Edit</th>
                        <th>
                            <button uk-icon="icon: trash; ratio:1.2;" ng-click="delete_dcr_users()"
                                    title="Delete the dcr_user" uk-tooltip></button>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    <!--<tr  ng-repeat="dcr_user in dcr_users | filter:search">-->
                    <tr ng-repeat="dcr_user in results.dcr_users |orderBy:orderByField:reverseSort | filter:search">
                        <!--      <tr  ng-repeat="dcr_user in dcr_users | filter:search">-->
                        <td><input type="checkbox" name="dcr_user_row" class="uk-checkbox" value="{{dcr_user.Id}}">
                        </td>
                        <td>{{serial_number = $index + 1}}</td>
                        <td>{{dcr_user.Name}}</td>
                        <td>{{dcr_user.Phone}}</td>


                        <td>
                            <a href="#dcr_user_modal"
                               ng-click="edit_dcr_user(dcr_user.Id,results.dcr_users.indexOf(dcr_user))"
            ...
            <div id="dcr_user_modal" class="uk-modal-container" uk-modal="bg-close:false">
                <div class="uk-modal-dialog">
                    ...
                    <div class="uk-modal-body" uk-overflow-auto>
                        ...
                        <form class="uk-form-horizontal">
                            <input type="text" id="dcr_user_modal_details" hidden>
                            ...
                            <!--    <div class="uk-margin">
                                    <label class="uk-form-label" for="form-horizontal-text">User Previlige</label>

                                    <div class="uk-form-controls">
                                        <select ng-model="form_privilege" class="uk-select">
                            ...
                            <div class="uk-margin">
                                <label class="uk-form-label" for="form-horizontal-text">Associated Branches</label>
                                ...
                                <div class="uk-form-controls">
                                    ...
                                    <div class="">
                                        ...
                                        <div id="stores_block"
                                             class="uk-margin uk-grid-small uk-child-width-1-2@m uk-grid">
                                            <?php for ($i = 0; $i < sizeof($stores); $i++) { ?>
                                                <label><input class="uk-checkbox" type="checkbox" name="selected_stores"
                                                              value="<?php echo $stores[$i]['BranchCode']; ?>"> <?php echo $stores[$i]['BranchName']; ?>
                                                </label>
                                            <?php } ?>
                    ...
                    <div class="uk-modal-footer uk-text-right">
                        ...
                        <button class="uk-button uk-button-primary" type="button" ng-click="save_dcr_user()">Save
                        </button>
                    </div>
...
<style>
    ...
    #dcr_user_modal > div > div.uk-modal-body.uk-overflow-auto > form > div:nth-child(8) > div > div > div:nth-child(3) > div {
