...
<script xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    function load_payment_details(count) {
        ...
        jQuery.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "index.php/console_controller/get_incomplete_transactions",
            dataType: 'json',
            data: {
...
<div class="uk-width-1-1@s uk-width-4-5@m uk-width-5-6@m uk-margin-auto-left content_wrapper">
    ...
    <div id="page-1-container">
        ...
        <div class="uk-card uk-align-center uk-card-default uk-card-hover uk-card-body">
            ...
            <h3 class="uk-heading-divider uk-text-center">Incomplete Payments</h3>
                ...
                <form class="uk-form-horizontal uk-margin-large uk-align-center">
                            ...
                            <div class="uk-form-controls">
                                <div class="uk-flex-inline">
                                    ...
                                    <select class="uk-select" id="start_date_time">
                                        <?php for ($i = 0; $i <= 9; $i++) { ?>
                                            <option
                                                value="<?php echo '0' . $i; ?>"><?php echo '0' . $i . ':00'; ?></option>
                                        <?php } ?>
                                        <?php for ($i = 10; $i <= 23; $i++) { ?>
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls uk-form-controls-text">
                            <label><input class="uk-checkbox" type="checkbox" id="generate_report"> Generate
                                Excel</label>
                        </div>
    ...
    <div id="res" class="uk-grid uk-overflow-auto uk-align-center"
        ...
        <div>
            <button id="load_more_details" class="uk-width-1-1 uk-button uk-button-default"
                    onclick="load_payment_details(count_payment_details)">Load More
            </button>
        </div>
    </div>
