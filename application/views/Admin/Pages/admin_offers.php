...
<div class="uk-width-1-1@s uk-width-4-5@m uk-width-5-6@m uk-margin-auto-left content_wrapper uk-padding">
    <div class="page-container">
        ...
        <div class="uk-card uk-align-center uk-card-default uk-card-hover uk-card-body">
            ...
            <h3 class="uk-heading-divider uk-text-center">Coupons</h3>
                        ...
                        <div id="" class="uk-card uk-card-default">
                            ...
                            <div class="uk-card-footer">
                                ...
                                <div class="uk-inline">
                                    ...
                                    <input class="new_editable_expiry uk-input" id="new_expiry" min="<?= date('Y-m-d'); ?>"
                                           type="date" value="">
                                           <!-- <input class="new_editable_expiry uk-input" id="new_expiry" min="<?= date('Y-m-d'); ?>"
                                           type="date" value=""> -->
                                ...
                                <div class="uk-card-footer">
                                    ...
                                    <div class="uk-inline">
                                        ...
                                        <input class="editable_expiry uk-input"
                                               ...
                                               type="text" value="<?php echo date('Y-m-d',strtotime($offers[$i]['expiry'])); ?>">
                                    </div>
                                    </p>
