	...
	t.fn.Tabledit = function (e) {
		...
		var i = this,
			a = {
				...
				restoreButton: !0,
				buttons: {
					edit: { class: "btn btn-sm btn-default", html: '<i class="fa fa-pen-alt" aria-hidden="true"></i>', action: "edit" },
				...
				columns: {
					...
					toolbar: function () {
						if (d.editButton || d.deleteButton) {
							...
							d.editButton && (t = '<button type="button" class="tabledit-edit-button btn btn-xs btn-primary" style="float: none;">' + d.buttons.edit.html + "</button>"),
							d.deleteButton &&
							((e = ''),
							...
							d.editButton && d.saveButton && (n = '<button type="button" class="tabledit-save-button  btn btn-xs btn-success" style="display: none; float: none;">' + d.buttons.save.html + "</button>"),
							d.deleteButton &&
							d.restoreButton &&
