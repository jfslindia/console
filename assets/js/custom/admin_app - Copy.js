...
jfsl_admin.controller('search_panel', function ($scope, $http, $compile,cfpLoadingBar,blockUI,$compile) {
                        ...
                        if (search_with != 'name') {
                            ...
                            for (var i = 0; i < response.data.result.user_details.length; i++) {
                                ...
                                var user_details_result='<tr>' +
                                    ...
                                    '<td> <button class="uk-button uk-button-default" ng-click="edit_user('+i+')">Edit</button> </td>' +
    ...
    $scope.edit_user=function(index){
        ...
        angular.element(document.getElementById("customer_name")).val($scope.customer_name);
        angular.element(document.getElementById("customer_mobile")).val($scope.customer_mobile);
        angular.element(document.getElementById("customer_email")).val($scope.customer_email);

        //angular.element(document.getElementById("save_user")).attr('ng-click','save_user('+user["id"]+')');

        /*Compiling the scope element to accomodate the changes in the dom*/
        /*$compile('#customer_name')($scope);
        $compile('#customer_mobile')($scope);
        $compile('#customer_email')($scope);*/

        //$compile('#save_user')($scope);

        //angular.element(document.getElementById("save_user")).attr('onclick','save_user('+user["id"]+')');
        $('#save_user').click(function(){
            ...
            $http({
                ...
                data: {
                    ...
                    mobile_number: $scope.customer_mobile,
...
jfsl_admin.controller('qc', function ($scope, $http, $compile, cfpLoadingBar,blockUI) {
    $scope.mode = 'default';
